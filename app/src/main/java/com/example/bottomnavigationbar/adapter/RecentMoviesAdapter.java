...
public class RecentMoviesAdapter extends RecyclerView.Adapter<RecentMoviesAdapter.MyViewHolder> {
    ...
    public RecentMoviesAdapter(ArrayList<Movie> movies, Context context) {
        mMovies = movies;
        mContext = context;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RecentMoviesAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecentMoviesAdapter.MyViewHolder holder, int position) {
